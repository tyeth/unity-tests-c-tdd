...
#define UNITY_FAIL_AND_BAIL   { Unity.CurrentTestFailed  = 1; UnityPrintEoFailReport(); TEST_ABORT(); }
#define UNITY_IGNORE_AND_BAIL { Unity.CurrentTestIgnored = 1; UNITY_OUTPUT_CHAR('\n');  TEST_ABORT(); }
/// return prematurely if we are already in failure or ignore state
#define UNITY_SKIP_EXECUTION  { if ((Unity.CurrentTestFailed != 0) || (Unity.CurrentTestIgnored != 0)) {return;} }
#define UNITY_PRINT_EOL       { UNITY_OUTPUT_CHAR('\r'); UNITY_OUTPUT_CHAR('\n'); }
#define UNITY_PRINT_TAB       { UnityPrint("  "); }
...
static void UnityPrintEoFailReport(void);
...
{
#ifndef UNITY_TO_CUNIT
    UnityTestResultsBegin(Unity.TestFile, line);
    UnityPrint("FAIL:");
#else
    UNITY_PRINT_TAB;UNITY_PRINT_TAB;UnityPrint("<test name=\"");
    UnityPrint(Unity.CurrentTestName);
    UnityPrint("\">");
    UNITY_PRINT_EOL;
    UNITY_PRINT_TAB;UNITY_PRINT_TAB;UNITY_PRINT_TAB;UnityPrint("<error number=\"");
    UnityPrintNumberUnsigned(Unity.TestFailures+1);
    UnityPrint("\" fatal=\"false\">");
    UNITY_PRINT_EOL;
    //print file
    UNITY_PRINT_TAB;UNITY_PRINT_TAB;UNITY_PRINT_TAB;UNITY_PRINT_TAB;UnityPrint("<file>");
    UnityPrint(Unity.TestFile);
    UnityPrint("</file>");
    UNITY_PRINT_EOL;
    //print line
    UNITY_PRINT_TAB;UNITY_PRINT_TAB;UNITY_PRINT_TAB;UNITY_PRINT_TAB;UnityPrint("<line>");
    UnityPrintNumberUnsigned(line);
    UnityPrint("</line>");
    UNITY_PRINT_EOL;
    UNITY_PRINT_TAB;UNITY_PRINT_TAB;UNITY_PRINT_TAB;UNITY_PRINT_TAB;UnityPrint("<expression>");
    //expression
...
void UnityConcludeTest(void)
{
    ...
    else if (!Unity.CurrentTestFailed)
    {
        ...
        UnityPrint("\">");
        UNITY_PRINT_EOL;
        UNITY_PRINT_TAB;UNITY_PRINT_TAB;UnityPrint("</test>");
#endif
...
static void UnityPrintEoFailReport(void)
{
    ...
    UNITY_PRINT_TAB;UNITY_PRINT_TAB;UNITY_PRINT_TAB;UNITY_PRINT_TAB;UnityPrint("</expression>");
    UNITY_PRINT_EOL;
    UNITY_PRINT_TAB;UNITY_PRINT_TAB;UNITY_PRINT_TAB;UnityPrint("</error>");
    UNITY_PRINT_EOL;
    UNITY_PRINT_TAB;UNITY_PRINT_TAB;UnityPrint("</test>");
    UNITY_PRINT_EOL;
#endif
...
void UnityBegin(void)
{
    ...
    Unity.CurrentTestFailed = 0;
    Unity.CurrentTestIgnored = 0;
#ifdef UNITY_TO_CUNIT
    UnityPrint("<registry name=\"");
    UnityPrint(Unity.TestFile);
    UnityPrint("\">");
    UNITY_PRINT_EOL;
    UNITY_PRINT_TAB;UnityPrint("<file>");
    UnityPrint(Unity.TestFile);
    UnityPrint("</file>");
    UNITY_PRINT_EOL;
    UNITY_PRINT_TAB;UnityPrint("<suite name=\"");
    UnityPrint(Unity.TestFile);
    UnityPrint("\">");
    UNITY_PRINT_EOL;
#endif
...
static volatile int m_i = 1000000;
void cu_exit(void)
{
...
int UnityEnd(void)
{
    ...
    UNITY_PRINT_EOL;
#else
    _U_UINT passed = Unity.NumberOfTests - (Unity.TestFailures+Unity.TestIgnores);
    UNITY_PRINT_TAB;UnityPrint("</suite>");
    UNITY_PRINT_EOL;
    UnityPrint("<!-- ");
    UnityPrintNumberUnsigned(Unity.NumberOfTests);
    UnityPrint(" tests - ");
    UnityPrintNumberUnsigned(passed);
    UnityPrint(" passed - ");
    UnityPrintNumberUnsigned((Unity.TestFailures+Unity.TestIgnores));
    UnityPrint(" failed - (total of ");
    UnityPrintNumberUnsigned((Unity.TestFailures+Unity.TestIgnores));
    UnityPrint(" failures) -->");
    UNITY_PRINT_EOL;
    UnityPrint("</registry>");
    UNITY_PRINT_EOL;
#endif
    /* modification for keil simulator. dummy loop and function name consistent with cunit  */
    while (m_i--);
...
// Warning: Win32 target does not support __WEAK symbols.
// Define this function always for PC tests
#ifndef WIN32
__WEAK
#endif
